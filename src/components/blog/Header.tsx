      ...
      <div className="container-custom">
        <div className="header-container">
          <Link href="/" className="logo">
            <svg className="logo-star" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 50 50" fill="currentColor">
              <path 
          ...
          <nav className="nav">
            ...
            <Link href="/posts" className={`nav-link ${isActive('/posts') ? 'nav-link-active' : ''}`}>
              Posts
            </Link>
            <Link href="/about" className={`nav-link ${isActive('/about') ? 'nav-link-active' : ''}`}>
              About
            </Link>
            <Link href="/tags" className={`nav-link ${isActive('/tags') ? 'nav-link-active' : ''}`}>
              Tags
            </Link>
            <button 
              onClick={toggleTheme}
